...
egl::Error PbufferSurfaceEAGL::swap(const gl::Context *context, SurfaceSwapFeedback *feedback)
{
    return egl::NoError();
}
...
void PbufferSurfaceEAGL::setSwapInterval(const egl::Display *display, EGLint interval) {}

gl::Extents PbufferSurfaceEAGL::getSize() const
{
